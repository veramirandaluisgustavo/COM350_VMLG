 ...
 * @author HP
 */
public class Aguila extends Animal implements IAve {
    String nombre;
    double peso;
    double tamanioAlas;
    ...
    public Aguila(String nombre, double peso, double tamanioAlas) {
        this.nombre = nombre;
        this.peso = peso;
    ...
    public String toString() {
        return "Aguila{" + "nombre=" + nombre + ", peso=" + peso + ", tamanioAlas=" + tamanioAlas + '}';
    }
